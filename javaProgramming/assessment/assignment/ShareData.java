...
public class ShareData 
{
   public static void main (String [] args) throws IOException
   {
      ...
      if (userOpt == 1)
      {
          ...
          System.out.println("\nEnter Data Amount in Megabytes");
          int dataBundles = 0;
      ...
      else if (userOpt == 3)
      {
          ...
          // replace ':' with '0' for easier comparison...
          String strTime = sysTime.replace(':', '0');

          // convert strTime to int
          int currentTime = Integer.parseInt(strTime);
          
          /*
             check if system time is between 18:00 and 21:00 hrs
             Note: The host system time should be in 24HR FORMAT
           */
          if (currentTime > 18000 && currentTime < 21000)
          {
              System.out.println(
